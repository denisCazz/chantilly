-- ============================================
-- AGGIORNA: Funzione customer_get_card()
-- Crea automaticamente tessera se mancante
-- ============================================

-- Aggiorna la funzione per creare automaticamente profile e tessera se mancanti
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE 'La funzione ora crea automaticamente profile e tessera se mancanti.';
    ELSE
